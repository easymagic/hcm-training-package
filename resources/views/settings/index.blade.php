                    ...
                    <div data-role="content">
                        ...
                        <i class="icon fa fa-wrench" aria-hidden="true"></i>{{__('Employee Reimbursement Settings')}}
                                ...
                                <a class="list-group-item setting-linker" href="{{ url('query')}}/settings" title="Query Settings">
                                    ...
                                    <a class="list-group-item setting-linker" href="{{ url('pfas')}}" title="Pension Fund Administrator Settings">
                                        <i class="icon fa fa-wrench" aria-hidden="true"></i>{{__('PFA Settings')}}
                                    </a>
                            </div>
                        </div>
                    </div>
