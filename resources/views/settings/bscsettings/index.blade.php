        		...
        		<div class="panel panel-info panel-line">
		          ...
		          <div class="panel panel-info panel-line">
		            <div class="panel-heading">
		              ...
		              <div class="panel-actions">
                			<button class="btn btn-info" data-toggle="modal" data-target="#addPerformanceCategoryModal">Add Grade Performance Category</button>
		                    ...
		                    <tbody>
		                    	...
		                    	<tr>
		                    		...
		                    		<td>
		                    			...
		                    			<span style="background: #03a9f4; color: white; padding: 3px;" class="label label-primary">{{$grade->level}}</span>,
		                    			@endforeach
		                    		</td>
		                    		<td>
				                    ...
				                    <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
				                      <a style="cursor:pointer;" class="dropdown-item" id="{{$performance_category->id}}" onclick="editPerformanceCategory(this.id)"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit Grade Performance Category</a>
				                       <a style="cursor:pointer;" class="dropdown-item" id="{{$performance_category->id}}" onclick="deletePerformanceCategory(this.id)"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete Grade Performance Category</a>
		          ...
		          <div class="panel panel-info panel-line">
		            <div class="panel-heading">
		              ...
		              <div class="panel-actions">
                			<button class="btn btn-info" data-toggle="modal" data-target="#addBehavioralSubMetricModal">Add Behavioral Sub Metric</button>
	                  ...
	                  <table    class="table table-striped ">
		                    ...
		                    <tbody>
		                    	...
		                    	<tr>
		                    		...
		                    		<td>{{$bsm->weighting}}</td>
		                    		<td>{{$bsm->measure}}</td>
		                    		<td>{{$bsm->low_target}}</td>
		                    		<td>{{$bsm->mid_target}}</td>
		                    		<td>{{$bsm->upper_target}}</td>
				                    ...
				                    <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
				                      <a style="cursor:pointer;" class="dropdown-item" id="{{$bsm->id}}" onclick="editBehavioralSubMetric(this.id)"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit Behavioral Sub Metric</a>
				                       <a style="cursor:pointer;" class="dropdown-item" id="{{$bsm->id}}" onclick="deleteBehavioralSubMetric(this.id)"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete Behavioral Sub Metric</a>
...
// });
  ...
  function deletePerformanceCategory(performance_category_id){
    ...
    alertify.error('Performance Category not deleted');
  });
