...
<style media="screen">
  ...
  .hmoPlaceholder{
    float: right; margin-top: 55px; height: 200px; border-radius: 5%;
  }
</style>
                ...
                <div class="input-group mb-3">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <select required class="form-control" name="hmoId" onchange="if (this.value) getBands(this.value)" id="hmoId">
                        <option value="">---------</option>
                ...
                <div class="input-group mb-3">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select required class="form-control" id="healthplantype" name="healthplantype" onchange="if (this.value) pullHospital(this.value)">
                    ...
                    <td data-dependants>
                     <fieldset>
                      ...
                      <div class="form-row" align="center" style="background-color: #eee; margin-bottom: 5px; height: 150px;">
                        <table> <tr> <td>
                          <img style="height: 150px; border-radius: 5%;" src="{{@$HMOSelfService->AttachDependant[$i]->passport <> '' ? asset('/assets/hmo/'.$HMOSelfService->AttachDependant[$i]->passport ) : asset('assets/images/hmo-placeholder.png') }}"/>
                        </td>
                        <td>
...
function pullHospital(BandName){
var varHMOid = $('#hmoId').val();
/////////Pull Hospitals Based on HMO//////
$.get('{{ url('/hmo/getHMOHospitalsList/') }}/' + varHMOid + '/' + BandName, function (data) {
