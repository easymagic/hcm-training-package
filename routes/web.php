...
//});
// Report
    Route::get('/report-home', 'ExcelReportController@index')->name('report-home')->middleware(['permission:view_hr_reports','auth']);
    Route::get('/report-master', 'ExcelReportController@master')->name('report-master')->middleware(['permission:view_hr_reports','auth']);
    Route::get('/report-exits', 'ExcelReportController@exits')->name('report-exits')->middleware(['permission:view_hr_reports','auth']);
    Route::get('/report-promotion', 'ExcelReportController@promotions')->name('report-promotions')->middleware(['permission:view_hr_reports','auth']);
...
Route::get('/hmo/getHMOHospitalsList/{id}/{bandName}', 'AARHMO@getHMOHospitalsList')->name('getHMOHospitalsList');
