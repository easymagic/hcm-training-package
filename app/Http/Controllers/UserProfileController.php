...
//        return \Auth::user()->other;
       ...
       return view('empmgt.profile',['queries'=>$queries,'user'=>$user,'qualifications'=>$qualifications,'countries'=>$countries,'competencies'=>$competencies,'companies'=>$companies,'banks'=>$banks,'company'=>$company,'grades'=>$grades,'departments'=>$departments,'jobs'=>$jobroles,'staff_categories'=>$staff_categories,'project_salary_categories'=>$project_salary_categories,'medical_history'=>$medical_history]);
    }
