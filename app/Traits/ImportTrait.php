		 ...
		 if($request->hasFile('template')){
             ...
             foreach($datas[0] as $row){
                 ...
                 if (!$old_user) {
                     ...
                     $user=User::create(['first_name'=>$row['firstname'],'middle_name'=>$row['middlename'],'last_name'=>$row['lastname'],'email'=>$row['email'],'phone'=>$row['phone'],'emp_num'=>$row['staffid'],'sex'=>$gender,
